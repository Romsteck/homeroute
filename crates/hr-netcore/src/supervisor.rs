...
pub enum ServicePriority {
    /// DNS, DHCP, proxy HTTPS -- restart immediat, retries illimites
    Critical,
...
/// Lance un service supervise dans une tache tokio
///
/// Le service est redemarr automatiquement en cas de panne ou de panic,
    ...
    Fut: Future<Output = anyhow::Result<()>> + Send + 'static,
{
    ...
    tokio::spawn(async move {
        ...
        loop {
            ...
            // Reset retry counter si le service a tourne plus de 60s
